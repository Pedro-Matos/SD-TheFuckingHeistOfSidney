...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$registryHostName "cd ~/heist/one_machine_Deploy/dir_registry/ ; ./registry_com.sh $registryHostName $registryPortNum $url &"
sleep 7
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$GeneralRepositoryHostName "cd ~/heist/one_machine_Deploy/dir_GeneralRepository/ ; ./serverSideGenRepo_com.sh $registryHostName $registryPortNum $url &" PID_Logging=$!
sleep 7
echo " "
...
echo "Setting Museum.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$MuseumHostName "cd ~/heist/one_machine_Deploy/dir_Museum/ ; ./serverSideMuseum_com.sh $registryHostName $registryPortNum $url &"
sleep 7
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$ConcentrationHostName "cd ~/heist/one_machine_Deploy/dir_ConcentrationSite/ ; ./serverSideConcentration_com.sh $registryHostName $registryPortNum $url &"
sleep 7
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$AssaultPartyHostName "cd ~/heist/one_machine_Deploy/dir_AssaultParty/ ; ./serverSideAssault_com.sh $registryHostName $registryPortNum $url &"
sleep 7
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$ColectionHostName "cd ~/heist/one_machine_Deploy/dir_CollectionSite/ ; ./serverSideCollection_com.sh $registryHostName $registryPortNum $url &"
sleep 7
echo " "

echo "Setting Ordinary Thieves.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$ThievesHostName "cd ~/heist/one_machine_Deploy/dir_Thief/ ; sh clientSideThief_com.sh $registryHostName $registryPortNum &"
sleep 10
echo " "

echo "Setting Master Thief.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$MasterThiefHostName "cd ~/heist/one_machine_Deploy/dir_MasterThief/ ; sh clientSideMaster_com.sh $registryHostName $registryPortNum &"
sleep 10
echo " "
...
sshpass -p $password  scp $username@$GeneralRepositoryHostName:~/heist/one_machine_Deploy/dir_GeneralRepository/Log.txt .
echo 4
