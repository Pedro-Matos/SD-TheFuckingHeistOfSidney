...
public class ConcentrationSite implements ConcentrationSiteInterface {
     ...
     */
    @Override
    public synchronized VectorTimestamp prepareExcursion(int ladraoID, VectorTimestamp vectorTimestamp) throws RemoteException {

        local.update(vectorTimestamp);

        this.thiefState[ladraoID] = CRAWLING_INWARDS;
        this.general.setThiefState(ladraoID,CRAWLING_INWARDS,local.clone());
        return local.clone();
    }
     ...
     */
    @Override
    public synchronized VectorTimestamp reverseDirection(int ladraoID, VectorTimestamp vectorTimestamp) throws RemoteException {
        local.update(vectorTimestamp);

        this.thiefState[ladraoID] = CRAWLING_OUTWARDS;
        this.general.setThiefState(ladraoID,CRAWLING_OUTWARDS,local.clone());
        return local.clone();
    }
     ...
     */
    @Override
    public synchronized VectorTimestamp atARoom(int ladraoID, VectorTimestamp vectorTimestamp) throws RemoteException {
        local.update(vectorTimestamp);

        this.thiefState[ladraoID] = AT_A_ROOM;
        this.general.setThiefState(ladraoID,AT_A_ROOM,local.clone());
        return local.clone();
    }
