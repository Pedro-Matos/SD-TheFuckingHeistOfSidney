...
public class CollectionSite implements CollectionSiteInterface {
     ...
     */
    @Override
    public synchronized VectorTimestamp prepareAssaultParty(int idGrupo, VectorTimestamp vectorTimestamp) throws RemoteException {
        ...
        general.setMasterThiefState(this.masterThiefState,local.clone());
        ...
        if (idGrupo == 1) {
            setAssaultParty2_room(j);
            System.out.println(Arrays.toString(local.toIntArray()));
        }
