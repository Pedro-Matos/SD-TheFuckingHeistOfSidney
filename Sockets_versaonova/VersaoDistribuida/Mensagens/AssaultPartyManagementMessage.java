 ...
 */
public class AssaultPartyManagementMessage implements Serializable {
     ...
     */
    public AssaultPartyManagementMessage(int msgType) {
     ...
     * @param info
     */
    public AssaultPartyManagementMessage(int msgType, int info) {
        this.msgType = msgType;
        this.info = info;
    }
     ...
     */
    public AssaultPartyManagementMessage(int msgType, int idGrupo, int id) {
        this.msgType = msgType;
        this.info = id;
     ...
     */
    public AssaultPartyManagementMessage(int msgType, int idGrupo, int id, int agilidade) {
        this.msgType = msgType;
     ...
     * @param info
     */
    public AssaultPartyManagementMessage(int msgType, boolean info) {
        this.msgType = msgType;


        switch (this.msgType) {
            case AssaultPartyManagementMessage.RESPROUBARQUADRO:
                this.quadro = info;
                break;
            case AssaultPartyManagementMessage.CHECKGRUPONULL:
                this.grupoNull = info;
                break;
            case AssaultPartyManagementMessage.RESPCHECKGRUPONULL:
                this.grupoNull = info;
                break;
        }
    }
